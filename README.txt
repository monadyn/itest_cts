...
============
	...
	cd /srv/trac/projects/Sandbox/plugins/
	sudo rm -r Bitten-0.6b2-py2.6.egg 
	sudo ln -s /usr/local/lib/python2.6/dist-packages/Bitten-0.6b2-py2.6.egg 
	sudo /etc/init.d/apache2 restart

bitten-slave -u Song.Shan -p Summer.2 http://wikisrv/Sandbox/build	
bitten-slave -u Song.Shan -p Summer.2 http://wikisrv/Sandbox/sql
bitten-slave http://wikisrv/Sandbox/builds

<slave version="2" name="wikisrv">
<platform processor="">x86_64</platform>
<os version="2.6.32-21-server" family="posix">Linux</os>
</slave>

sudo trac-admin /srv/trac/projects/Sandbox repository resync 
